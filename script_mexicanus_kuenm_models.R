...
############################################
######### ETAPA 1 #########################
setwd("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/")### directorio donde estan todos los archivos 

############################################
######### The model creation ###############
############################################
occ_joint <- "Ara_mexicanus_joint.csv"##archivo que tiene los datos completos
occ_tra <- "Ara_mexicanus_train.csv"##archivo que tiene el 80% de los datos para entrenar
...
############################################
occ_test <- "Ara_mexicanus_test.csv"##indicar donde esta el archivo para evaluar a los 620 modelos
...
############################################
occ_ind <- "Ara_mexicanus_ind.csv"##Elegir el archivo de 20% de los datos que nunca se usaron para evaluar el modelo
...
presente <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_median.asc")
plot(presente)

#2. Llamar al archivo .csv de los puntos utilizados para el training del modelo final.
data_spp <- read.csv2("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Ara_mexicanus_joint.csv", sep = ",", header = TRUE)
...
data_testing_spp <- read.csv2("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Ara_mexicanus_ind.csv", sep = ",", header = TRUE)
...
writeRaster(presente_bin, filename= "Ara_mexicanus_m_present.asc", overwrite=T, suffix='names')
...
presente_todo <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_presente_completo_median.asc")##modelo del CCSM
...
setwd("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/mapas_finales_binarios/")#RUTA DEL DIRECTORIO DE DONDE Guardar las capas
writeRaster(presente_todo_bin, filename= "Ara_mexicanus_present_todo.asc", overwrite=T, suffix='names')
...
########################################################################
#1.llamar las capas (modelos/replicas) que se hicieron del futuro 2040 (uno por cada laboratorio)
Holoceno_1 <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_MH_CCSM_median.asc")##modelo del CCSM
Holoceno_2 <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_MH_MIROC_median.asc")##modelo del MIROC
Holoceno_3 <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_MH_MPI_ESM_median.asc")##modelo del MPI_ESM
...
#4.Guardar el mapa de 2040 DISPERSION 
setwd("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/mapas_finales_binarios/")#RUTA DEL DIRECTORIO DE DONDE Guardar las capas
writeRaster(map_holoceno_fin, filename= "Ara_mexicanus_holoceno.asc", overwrite=T, suffix='names')
...
###################################################################
#1.llamar las capas (modelos/replicas) que se hicieron del futuro 2040 (uno por cada laboratorio)
LGM_1 <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_LGM_CCSM_median.asc")##modelo del CCSM
LGM_2 <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_LGM_MIROC_median.asc")##modelo del MIROC
LGM_3 <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_LGM_MPI_ESM_median.asc")##modelo del MPI_ESM
...
#4.Guardar el mapa de 2040 DISPERSION 
setwd("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/mapas_finales_binarios/")#RUTA DEL DIRECTORIO DE DONDE Guardar las capas
writeRaster(map_LGM_fin, filename= "Ara_mexicanus_LGM.asc", overwrite=T, suffix='names')
...
###################################################################
#1.llamar las capas (modelos/replicas) que se hicieron del futuro 2040 (uno por cada laboratorio)
LIG_1 <- raster("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/kuenm_models_spp/ara_mexicanus/Final_Models/M_1.4_F_qth_Set_1_EC/Ara_militaris_LIG_CCSM_median.asc")##modelo del CCSM
...
#4.Guardar el mapa de 2040 DISPERSION 
setwd("D:/proyectos_sigs/ara_militaris_paco/new_project_2023/mapas_finales_binarios/")#RUTA DEL DIRECTORIO DE DONDE Guardar las capas
writeRaster(LIG_1_bin, filename= "Ara_mexicanus_LIG.asc", overwrite=T, suffix='names')
##FIN!
